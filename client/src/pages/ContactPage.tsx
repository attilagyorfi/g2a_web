...
import { Phone, Mail, Clock, MapPin, Send, CheckCircle, QrCode } from "lucide-react";
...
export default function ContactPage() {
  ...
  const contactItems = [
    ...
    { icon: <Clock size={20} />, label: t("footer.workingHours"), value: t("footer.workingHoursValue"), href: null },
    { icon: <MapPin size={20} />, label: t("contact.location"), value: t("contact.addressValue"), href: null },
  ];
