  ...
  return (
    <div>
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "2rem" }}>
        ...
        <div style={{ backgroundColor: "rgba(233,17,48,0.1)", border: "1px solid rgba(233,17,48,0.3)", borderRadius: "6px", padding: "0.5rem 1rem", color: "var(--g2a-amber)", fontFamily: "Roboto Mono, monospace", fontSize: "0.875rem" }}>
          ...
          <tbody>
            {(subscribers || []).map(sub => (
              <tr key={sub.id} style={{ borderBottom: "1px solid rgba(255,255,255,0.05)" }}>
                ...
                <td style={{ padding: "0.875rem 1rem" }}>
                  <button onClick={() => { if (confirm("Biztosan törli ezt a feliratkozót?")) deleteMutation.mutate({ id: sub.id }); }} style={{ background: "none", border: "none", color: "#888", cursor: "pointer" }} onMouseEnter={e => (e.currentTarget.style.color = "var(--g2a-amber)")} onMouseLeave={e => (e.currentTarget.style.color = "#888")}>
                    <Trash2 size={15} />
                  </button>
                </td>
              </tr>
