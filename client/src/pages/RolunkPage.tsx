  ...
  return (
    <>
      <SeoHead
        ...
        description="Ismerd meg a G2A Marketing csapatát. 2022 óta segítünk B2B cégeknek mérhető marketing eredményeket elérni. Stratégiai gondolkodás, AI-alapú megoldások, 23+ aktív partner."
      />
      <ScrollProgressBar />
      <Navigation />
        ...
        <section style={{
          ...
          <div className="g2a-container" style={{ position: "relative", zIndex: 1, padding: "4rem 1.5rem" }}>
            ...
            <p className="animate-fadeInUp" style={{ animationDelay: "0.3s", fontSize: "1.15rem", color: "var(--g2a-text-secondary)", maxWidth: "600px", lineHeight: "1.7", fontFamily: "Inter, sans-serif" }}>
              2022 óta segítünk B2B cégeknek mérhető marketing eredményeket elérni. Nem csak ügynökség vagyunk – stratégiai partnerek vagyunk a hosszú távú növekedésben.
            </p>
          </div>
        </section>
        ...
        <section style={{ padding: "3rem 0", backgroundColor: "var(--g2a-bg-2)", borderTop: "1px solid var(--g2a-border)", borderBottom: "1px solid var(--g2a-border)" }}>
          <div className="g2a-container">
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(160px, 1fr))", gap: "2rem", textAlign: "center" }}>
              {[
                { num: "2022", label: "Alapítás éve" },
                { num: "23+", label: "Aktív partner" },
                { num: "8+", label: "Iparág" },
                { num: "3", label: "Aktív év" },
                { num: "100%", label: "Elkötelezettség" },
              ].map((s, i) => (
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "5rem", alignItems: "center" }}>
              <div>
                ...
                <p className="reveal reveal-delay-2" style={{ color: "var(--g2a-text-secondary)", lineHeight: "1.8", marginBottom: "1.5rem", fontFamily: "Inter, sans-serif" }}>
                  A G2A Marketing 2022-ben alakult Pécsett, azzal a céllal, hogy a kis- és középvállalkozásoknak is elérhető legyen a prémium minőségű, adatvezérelt marketing.
                </p>
                <p className="reveal reveal-delay-3" style={{ color: "var(--g2a-text-secondary)", lineHeight: "1.8", marginBottom: "2rem", fontFamily: "Inter, sans-serif" }}>
                  Ma már 8+ iparágban dolgozunk, és minden projektünkbe integráljuk a legújabb AI-alapú megoldásokat. Büszkék vagyunk arra, hogy 23+ aktív partnerünk van és folyamatosan növekszünk.
                </p>
