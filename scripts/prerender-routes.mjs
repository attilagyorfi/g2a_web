...
export const SERVICES = [
  { slug: "arculattervezes", title: "Arculattervezés és branding 2026 – Vizuális identitás | G2A Marketing", description: "Logó, arculati kézikönyv, nyomtatott és digitális anyagok tervezése KKV-knak és B2B cégeknek. Építs következetes, bizalmat építő vizuális identitást. Kérd az ajánlatot!", ogTitle: "Arculattervezés" },
  { slug: "hirdeteskezeles", title: "PPC & Hirdetéskezelés 2026 — több-platformos kampánymenedzsment | G2A Marketing", description: "Több-platformos PPC menedzsment: Google Ads, Meta, LinkedIn, TikTok egy stratégiában. Adatvezérelt struktúra, A/B tesztek, konverziókövetés. Kérd az ingyenes audit!", ogTitle: "Hirdetéskezelés" },
  { slug: "kozossegi-media", title: "Közösségi média menedzsment 2026 — márkaépítés | G2A Marketing", description: "Social media stratégia, tartalomgyártás, közösségkezelés és influencer marketing Facebookon, Instagramon, LinkedInen és TikTokon. Kérd a díjmentes social auditot!", ogTitle: "Közösségi média" },
  { slug: "strategiai-marketing", title: "Stratégiai marketing tanácsadás 2026 – Audit, KPI, akcióterv | G2A Marketing", description: "Marketing audit, piac- és versenytárselemzés, persona, marketing mix és KPI-vezérelt akcióterv KKV-knak és B2B cégeknek. Kérd az ingyenes konzultációt.", ogTitle: "Stratégiai marketing" },
  { slug: "keresooptimalizalas", title: "Keresőoptimalizálás (SEO) szakértőkkel 2026 – G2A Marketing", description: "Technikai SEO audit, on-page, tartalom-SEO, linképítés és lokális SEO mérhető organikus növekedésért. Átlátható havi riport, AI-keresés. Kérd az auditot!", ogTitle: "Keresőoptimalizálás (SEO)" },
  { slug: "webfejlesztes", title: "Webfejlesztés és CRO 2026 — konverzióra optimalizált weboldalak | G2A Marketing", description: "Egyedi weboldal, WordPress, Shopify és WooCommerce webáruház, landing page és CRO. Gyors, reszponzív, SEO-barát fejlesztés mérhető konverzióval. Kérj auditot!", ogTitle: "Webfejlesztés" },
