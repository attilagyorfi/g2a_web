...
await insertIfEmpty('testimonials', [
  ...
  { quote: 'Kiváló csapat, professzionális hozzáállás. A webfejlesztési projektünk pontosan határidőre elkészült, és az eredmények magukért beszélnek.', authorName: 'Kovács Péter', authorTitle: 'Marketing vezető', authorCompany: 'GRB Skin Clinic', isActive: 1, sortOrder: 1 },
  { quote: 'A G2A Marketing segítségével 3 hónap alatt megdupláztuk az organikus forgalmunkat. Az SEO munkájuk kiemelkedő.', authorName: 'Nagy Balázs', authorTitle: 'CEO', authorCompany: 'Vidashop', isActive: 1, sortOrder: 2 },
]);
